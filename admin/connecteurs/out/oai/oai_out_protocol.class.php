...
// +-------------------------------------------------+
// $Id: oai_out_protocol.class.php,v 1.29.2.2 2023/08/03 15:34:10 jparis Exp $
...
class oai_out_get_records_notice extends oai_out_get_records
{
     ...
     * @return []
     */
    public function getRecordsBySet($set_id = 0, $format, $datefrom = 0, $dateuntil = 0, $record_ids = [])
    {
