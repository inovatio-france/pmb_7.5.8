...
// +-------------------------------------------------+
// $Id: cms_module_common_view_animationslist.class.php,v 1.4 2023/02/16 13:50:55 qvarin Exp $
...
{% endfor %}";
	...
	public function render($data) {
	    ...
	    if(isset($data['paging']) && $data['paging']['activate']) {
	        $render_data['paging'] = $data['paging'];
	    }
