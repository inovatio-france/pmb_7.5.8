...
// +-------------------------------------------------+
// $Id: cms_module_animationslist_view_calendar_django.class.php,v 1.2 2023/01/04 15:35:58 qvarin Exp $
...
<div>
  ...
  {% endfor %}
	...
	public function render($datas) {
        ...
        $animations = encoding_normalize::json_encode($this->utf8_normalize($renderDatas['animations']));
        if (empty($animations)) {
            $animations = "{}";
        }
