...
// +-------------------------------------------------+
// $Id: options.class.php,v 1.2.6.3 2024/01/19 11:12:26 dgoron Exp $
		...
		switch ($field_type) {
			case 'checkbox' :
				if (empty ( $default_value ))
					$default_value = '1';
				return "<input type='checkbox' id='" . $name . "' name='" . $name . "' " . ($this->parameters[$name][0]['value'] == $default_value ? "checked='checked'" : '') . " value='" . $default_value . "'/>";
			case 'number' :
