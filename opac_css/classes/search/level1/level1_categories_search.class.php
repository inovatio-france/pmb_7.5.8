...
// +-------------------------------------------------+
// $Id: level1_categories_search.class.php,v 1.3.12.2 2023/08/31 12:56:46 qvarin Exp $
			...
			foreach ($list_thes as $id_thesaurus=>$libelle_thesaurus) {
				...
				if ($nb) {
					...
					if($tab == 'affiliate') {
						...
						$display .= "<a href=\"#\" onclick=\"document.forms.".$this->get_hidden_search_form_name().".count.value='".$nb."';submitSearch_CategorieForm('".$id_thesaurus."','".$nb."'); return false;\">".$msg['suite']."&nbsp;<img src='".get_url_icon('search.gif')."' style='border:0px' align='absmiddle'/></a>";
					}
