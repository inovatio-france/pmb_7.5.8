...
// +-------------------------------------------------+
// $Id: list_opac_bannettes_abon_ui.class.php,v 1.1.2.2 2023/11/28 10:31:27 dgoron Exp $
	...
	protected function get_cell_content($object, $property) {
		...
		switch($property) {
			case 'name':
		        ...
		        $content .= "<a href=\"".str_replace("!!id_bannette!!", $object->id_bannette, $link_to_bannette)."\" $java_comment >";
			    $content .= $object->get_render_comment_public();
		        $content .= "</a>";
