...
// +-------------------------------------------------+
// $Id: list_opac_rss_ui.class.php,v 1.1.2.3 2023/09/29 08:32:42 dgoron Exp $
		...
		switch($property) {
		    case 'img_url_rss_flux':
		        if ($object->img_url_rss_flux) {
		            $content .= "<a href=\"index.php?lvl=rss_see&id=".$object->id_rss_flux."\"><img src='".$object->img_url_rss_flux."' border='none' /></a>";
		        }
		        break;
		    case 'nom_rss_flux':
		        ...
		        break;
			case 'permalink':
			    $content .= "<a href=\"".$opac_url_base."rss.php?id=".$object->id_rss_flux."\" title=\"".$msg['abonne_rss_dispo']."\"><img id=\"rss_logo\" alt='rss' src='".get_url_icon('rss.png', 1)."' border=0 /></a>";
				break;
			default :
