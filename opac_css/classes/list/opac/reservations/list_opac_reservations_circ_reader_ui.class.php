...
// +-------------------------------------------------+
// $Id: list_opac_reservations_circ_reader_ui.class.php,v 1.1.2.2 2024/01/03 14:50:34 dgoron Exp $
...
// 	        	break;
	        case 'resa_delete':
	            if ($object->id_notice) {
	                $content .= "<a href='javascript:if(confirm(\"".$msg['empr_confirm_delete_resa']."\")){location.href=\"empr.php?tab=loan_reza&lvl=all&delete=1&id_notice=".$object->id_notice."#empr-resa\"}'>".$msg['resa_effacer_resa']."</a>";
	            } else {
	                $content .= "<a href='javascript:if(confirm(\"".$msg['empr_confirm_delete_resa']."\")){location.href=\"empr.php?tab=loan_reza&lvl=all&delete=1&id_bulletin=".$object->id_bulletin."#empr-resa\"}'>".$msg['resa_effacer_resa']."</a>";
	            }
	            break;
	        default :
