...
// +-------------------------------------------------+
// $Id: record_datas.class.php,v 1.156.2.12 2024/04/25 12:24:25 rtigero Exp $
	...
	*/
	...
	public function get_categories() {
		if (!isset($this->categories)) {
			...
			$query = "select distinct num_noeud from notices_categories where notcateg_notice = " . intval($this->id) . " order by ordre_vedette, ordre_categorie";
			$result = pmb_mysql_query($query);
