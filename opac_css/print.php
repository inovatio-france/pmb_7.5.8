...
// +--------------------------------------------------------------------------+
// $Id: print.php,v 1.139.4.14 2024/07/04 08:15:54 qvarin Exp $
...
global $opac_biblio_name, $opac_parse_html, $opac_url_base, $id_segment;
...
if ($action != "print_$lvl") {
    ...
    $output_final .= "
        ...
        <div id='att'></div>
        <h2 class='print_title'><!-- print_title --></h2>
        <h3 class='print_options'>{$msg["print_options"]}</h3>
	...
	<div id='other_docnum_part'>
		<label for='notice_tpl'><b>{$msg["print_type_title"]}</b></label>
		<blockquote>
			{$sel_notice_tpl}
