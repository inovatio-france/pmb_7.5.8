...
// +-------------------------------------------------+
// $Id: Model.php,v 1.22.2.8 2023/05/16 14:10:59 jparis Exp $
...
class Model
{
    ...
    /**
     * Permet de savoir les donnees de l'ORM sont recupere
     *
     * @var boolean
     */
    ...
    /**
     * Contient la liste des propriete recuperer par l'ORM
     *
     * @var array
     */
    protected $structure = [];
    ...
    {
        if (!$this->datafetch && $this->ormName::exist($this->id)) {
    ...
    * @param mixed $fields tableau de parametres pour la requete
    ...
    */
    ...
    /**
     * Retourne une chaine contenant le namespace suivie de son identifiant
     *
     * @return string
     */
