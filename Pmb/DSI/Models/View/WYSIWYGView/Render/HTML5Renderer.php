...
// +-------------------------------------------------+
// $Id: HTML5Renderer.php,v 1.1.2.17 2024/03/21 15:58:29 jparis Exp $
...
class HTML5Renderer
{
	...
	protected function renderImportViewElement($currentElement)
	{
		if ($currentElement->content && $currentElement->content->viewId) {
			...
			return $subView->render($this->item, $this->view->entityId, $subView->settings->limit ?? 0, $subView->context);
		}
