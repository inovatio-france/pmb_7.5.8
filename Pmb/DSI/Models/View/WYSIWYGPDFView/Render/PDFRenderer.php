...
// +-------------------------------------------------+
// $Id: PDFRenderer.php,v 1.1.2.2 2023/07/26 13:45:22 qvarin Exp $
...
class PDFRenderer extends HTML5Renderer
{
    ...
    protected function renderBlockElement($currentElement)
    {
        ...
        if (
            $currentElement->root ||
            empty($currentElement->blocks) ||
            count($currentElement->blocks) == 1
        ) {
    ...
    protected function renderImageElement($currentElement)
    {
        ...
        return str_replace(
            ['!!style!!', '!!content!!'],
            [$this->getStyleString($currentElement->style->block), parent::renderImageElement($currentElement)],
    ...
    protected function renderTextElement($currentElement)
    {
        return str_replace(
            ['!!style!!', '!!content!!'],
            ["width:100%;", parent::renderTextElement($currentElement)],
            static::BLOC_ELEMENT_TEMPLATE
        );
    }
    ...
    protected function renderRichTextElement($currentElement)
    {
        return str_replace(
            ['!!style!!', '!!content!!'],
            ["width:100%;", parent::renderRichTextElement($currentElement)],
            static::BLOC_ELEMENT_TEMPLATE
        );
    }
    ...
    protected function renderViewElement($currentElement)
    {
        return str_replace(
            ['!!style!!', '!!content!!'],
            ["width:100%;position:relative;", parent::renderViewElement($currentElement)],
            static::BLOC_ELEMENT_TEMPLATE
        );
    }
